...
google.bookmarkbubble.Bubble.prototype.build_ = function() {
  ...
  if (this.getIosVersion_() >= this.getVersion_(4, 2)) {
    bubbleInner.innerHTML = '矢印をタップして<b>ホーム画面に追加</b>できます';
  } else {
    bubbleInner.innerHTML = '矢印をタップして<b>ホーム画面に追加</b>できます';
  }
  ...
  arrow.style.border = 'solid 3px #1abc9c';
  ...
  close.style.border = '3px solid transparent';
